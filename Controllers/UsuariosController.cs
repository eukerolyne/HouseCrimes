...
namespace HouseCrimes.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("usuarioId,usuarioNome,usuarioSobrenome,usuarioDtnascimento,usuarioTelefone,usuarioEmail,usuarioNickname,usuarioPassword,usuarioTipo")] Usuario usuario)
        {
